classdef BeamformParameterConverter
    ...
    methods (Static)
        ...
        function bp = VsxToBpV2(vsx, transmitGroup, compressionKind)
            ...
            bp.transducer_bandwidth = die.Bandwidth; % TODO
            ...
            switch bp.header.acquisition_mode
                case ZBP.AcquisitionKind.FORCES
                    bp.acquisition_parameters(bp.header.raw_data_dimension(3)) = ZBP.FORCESParameters;
                case ZBP.AcquisitionKind.UFORCES
                    bp.acquisition_parameters(bp.header.raw_data_dimension(3)) = ZBP.uFORCESParameters;
                case ZBP.AcquisitionKind.HERCULES
                    bp.acquisition_parameters(bp.header.raw_data_dimension(3)) = ZBP.HERCULESParameters;
                case ZBP.AcquisitionKind.RCA_VLS
                    bp.acquisition_parameters = ZBP.VLSParameters;
                ...
                case ZBP.AcquisitionKind.RCA_TPW
                    bp.acquisition_parameters = ZBP.TPWParameters;
                    bp.tilting_angle = single([transmitGroup.TransmitFocus.SteeringAngle]);
                case ZBP.AcquisitionKind.UHERCULES
                    bp.acquisition_parameters(bp.header.raw_data_dimension(3)) = ZBP.uHERCULESParameters;
            end
            ...
            if bp.header.acquisition_mode == ZBP.AcquisitionKind.FORCES || bp.header.acquisition_mode == ZBP.AcquisitionKind.HERCULES ...
                ...
                for i = 1:bp.header.raw_data_dimension(3)
                    bp.acquisition_parameters(i).transmit_focus.focal_depth = transmitGroup(i).TransmitFocus.FocalDepth;
                    bp.acquisition_parameters(i).transmit_focus.steering_angle = transmitGroup(i).TransmitFocus.SteeringAngle;
                    bp.acquisition_parameters(i).transmit_focus.transmit_receive_orientation = transmitGroup(i).TransmitReceiveOrientations.packTransmitReceiveOrientations();
                end
            end
            ...
            assert(isfield(bp, "acquisition_parameters"), "Unsupported acquisition mode!");
        end
