...
% filename = "260305_MN32-4_Example_Filename_FORCES-Tx-Column";
% filename = "260305_MN32-4_Example_Filename_uFORCES-16-Tx-Row-Chirp-2e-05";
% filename = "260305_MN32-4_Example_Filename_VLS-128-1deg-Tx-Row-Chirp-2e-05";
% filename = "260305_MN32-4_Example_Filename_TPW-128-10deg-Tx-Row-Chirp-2e-05";
% filename = "260305_MN32-4_Example_Filename_uFORCES-16-Tx-Column-Chirp-2e-05";
...
% filename = "260305_MN32-4_Example_Filename_uFORCES-16-Walking-8-Tx-Row-Chirp-2e-05";
...
if isempty(bp.data)
    bp.data = ornot.DataFromFile(bp, data_filename);
end
